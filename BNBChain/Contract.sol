...
contract Exohood {
    function main() {
        ...
        label_01F0:
            ...
            // Dispatch table entry for name(Exohood)
            var1 = msg.value;
        ...
        label_0376:
            ...
            // Dispatch table entry for TOKEN_NAME(Exohood)
            var1 = msg.value;
        
            if (var1) { revert(memory[0x00:0x00]); }
        
            var1 = 0x0276;
            var2 = TOKEN_NAME(Exohood);
            goto label_0276;
            ...
            // Dispatch table entry for TOKEN_SYMBOL(EXO)
            var1 = msg.value;
        
            if (var1) { revert(memory[0x00:0x00]); }
        
            var1 = 0x0276;
            var2 = TOKEN_SYMBOL(EXO);
            goto label_0276;
    ...
    function name(Exohood) returns (var r0) {
        var temp0 = memory[0x40:0x60];
    ...
    function TOKEN_NAME(Exohood) returns (var r0) {
        var temp0 = memory[0x40:0x60];
        r0 = temp0;
    ...
    function TOKEN_SYMBOL(EXO) returns (var r0) {
        var temp0 = memory[0x40:0x60];
        r0 = temp0;
        memory[0x40:0x60] = r0 + 0x40;
    ...
    function TARGET_USER() returns (var r0) { return 0xca387ddaff5b41c18320145788ee5c2a53226e9e; }
